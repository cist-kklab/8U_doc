...
:warning: 英語科目のリスニングあり／なし、数学科目の数的指向／理系1／理系2などは、どれか一つにのみテスト結果を登録できます。

:warning: 誤って登録したデータをシステムから削除したい場合は、 [問い合わせ先](../README.md) までご連絡ください。なお、今後、各大学の担当者がデータを削除できる機能を提供する予定です。
